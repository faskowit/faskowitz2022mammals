% compute_gdd_standalone
%
% function [gdd_star,t_star,t_upperbound]=compute_gdd_standalone(A1,A2)
%
...
%-DISCLAIMER---------------------------------------------------------------
% This code was used for results published in the GlobalSIP'13 conference
...
function [gdd_star,t_star,t_upperbound]=compute_gdd_pd(V1,D1,V2,D2)
    ...
    [x,fval,~]=fminbnd(m_dmf,0,t_upperbound,options);
    gdd_star=sqrt(-fval);
    t_star=x;
